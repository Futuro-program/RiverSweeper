namespace Assets.Scripts.Water
{
    ...
    {
        [SerializeField] private Renderer rendererWater;
        ...
        public void Awake()
        {
            ...
            rendererWater.GetPropertyBlock(defaulPropertyBlock);
        }
        ...
        public void OnTriggerEnter(Collider collider)
        {
            if (collider.CompareTag("Water"))
            {
                ...
                rendererWater.sharedMaterial = waterMaterial;
                rendererWater.SetPropertyBlock(waterPropertyBlock);
            }
        }
        ...
        public void OnTriggerExit(Collider collider)
        {
            if (collider.CompareTag("Water"))
            {
                rendererWater.sharedMaterial = diffuseMaterial;
                rendererWater.SetPropertyBlock(defaulPropertyBlock);
            }
        }
    }
}
