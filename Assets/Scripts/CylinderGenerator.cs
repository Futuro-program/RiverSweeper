// Script pego de Sebastian Lague -> GitHub https://github.com/SebLague
// Levemente modificado a partir do código original
...
public static class CylinderGenerator
{
	...
	static PathVertex[] CalcNormals(Vector3[] localPoints)
	{
		...
		for (int i = 0; i < localPoints.Length; i++)
		{
			...
			verts[i] = new() {tangent = tangent, normal = normal};
		}
		return verts;
	}
